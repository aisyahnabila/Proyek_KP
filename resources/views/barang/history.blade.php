        ...
        <div class="flex flex justify-end items-center mb-4">
            <div>
                <a href="{{ route('kelola.index') }}"
                    class="shadow-lg focus:outline-none text-black bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:focus:ring-yellow-900 ml-auto">Home</a>
            </div>
        </div>
