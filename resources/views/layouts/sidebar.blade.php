...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-base">
        <span class="flex-1 text-white">Menu</span>
        <ul class="space-y-2 font-medium">
            {{-- dashboard --}}
            <li>
                <a href="{{ route('dashboard') }}"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-yellow-500 dark:hover:bg-yellow-400 group">
            ...
            <li>
                <a href="#"
                    class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-yellow-500 dark:hover:bg-gray-700 group">
            ...
            <span class="flex-1 text-white">Laporan</span>
