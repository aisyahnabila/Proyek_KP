                ...
                <div class="flex justify-end items-center p-4 bg-white dark:bg-gray-900 space-x-4">
                    ...
                    <div class="relative w-full lg:w-auto lg:px-0">
                        <div class="relative">
                            ...
                            <input type="text" id="table-search-items" class="block w-full p-2 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Cari">
                        </div>
                    </div>
                </div>
